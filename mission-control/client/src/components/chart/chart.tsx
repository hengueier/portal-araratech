...
import Style from "./chart.tailwind";
import * as Methods from "./methods";

const Options = import("./options.json");

export function Chart(props) {
  // state
  const [data, setData] = useState<any>(null); // TODO: Type this // TODO: Type this
...
function setChartColors(props, data) {
  // set the color
  const Colors = import("./colors.json");
  let colors = [];
