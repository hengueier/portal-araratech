 ...
 *
 *   TABLE
 *   Please view the full documentation: https://docs.Sample.app/ui/table
 *
 *   PROPS
...
import Style from "./table.tailwind";

export function Table(props) {
  // state
  const [header, setHeader] = useState<any>(null); // TODO: Type this // TODO: Type this
  const [body, setBody] = useState<any>(null); // TODO: Type this // TODO: Type this
  const [filter, setFilter] = useState<any>(false); // TODO: Type this // TODO: Type this
  ...
  function sort(column, direction) {
    const rows: any = filter.length ? [...filter] : [...body];
