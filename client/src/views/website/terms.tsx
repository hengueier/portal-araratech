  ...
  return (
    <Article>
      ...
      <p>
        ...
        [YOUR_DOMAIN] website and all domains, webpages, sub domains and
        subparts therein contained (the 'WEBSITE'). All services available
        through the WEBSITE are provided by [YOUR_FULL_COMPANY NAME].
        (“[YOUR_COMPANY]”).
      </p>
      ...
      <p>
        ...
        procedures that be published from time to time on the WEBSITE by by
        [YOUR_COMPANY] (collectively, 'THE AGREEMENT').
      </p>
      ...
      <p>
        [YOUR_COMPANY] provides [DESCRIPTION_OF_YOUR_SERVICE]. Payments are
      ...
      <p>
        [YOUR_COMPANY] reserves the right, at its sole discretion, to modify or
      ...
      <p>
        [YOUR_COMPANY] hereby grants you a non-exclusive, non-transferable,
      ...
      <p>
        ...
        account. You agree to immediately notify [YOUR_COMPANY] of any
        unauthorised access to your account. [YOUR_COMPANY] will not be liable
        for any loss, damage or other liability arising from your failure to
        comply with this section of the TOS or from any unauthorised access to
      ...
      <p>
        ...
        [YOUR_COMPANY] a non-exclusive, worldwide, royalty-free, transferable
      ...
      <p>
        [YOUR_COMPANY] will not be liable for any loss, damage or harm resulting
        from the posting of your CONTENT. [YOUR_COMPANY] reserves the right to,
        in it's sole discretion, refuse or remove any content that, in
        [YOUR_COMPANY’S] reasonable opinion, violates any [YOUR_COMPANY] policy
        or is in any way harmful. [YOUR_COMPANY] reserves the right to terminate
        or deny access to the use of the WEBSITE and or SERVICES to any
        individual or organisation for any reason in [YOUR_COMPANY’S] sole
        discretion.
      </p>
      ...
      <p>
        [YOUR_COMPANY] has not reviewed, and cannot review all of the material
        ...
        horses or other destructive or harmful content.
      </p>
      ...
      <p>
        [YOUR_COMPANY] has not reviewed and cannot review material included on
        third party websites which is made available through the websites and
        webpages to which [YOUR_COMPANY] links to. [YOUR_COMPANY] does not have
        any control over material made available on websites other than the
        WEBSITE.
      </p>

      <p>
        [YOUR_COMPANY] accepts no responsibility for any harm, loss or damage as
        a result of CONTENT posted to the WEBSITE, made available through the
      ...
      <p>
        [YOUR_COMPANY] accepts no responsibility for any harm, loss or damage as
        a result of you, or any other user breaching the General Data Protection
        Regulation (GDPR).
      </p>
      ...
      <p>
        [YOUR_COMPANY] accepts no responsibility for any harm, loss or damage as
        a result of using third party FPM.
      </p>

      <h2>5. Termination</h2>

      <p>
        [YOUR_COMPANY], in its sole discretion, may terminate access to your
        ...
        and for any reason or no reason. If you wish to terminate this
        AGREEMENT, you should discontinue to use this WEBSITE.
      </p>
      ...
      <p>
        [YOUR_COMPANY] reserves the right at any time to, and from time to time
        may modify, suspend or discontinue, temporarily or permanently, the
        SERVICES or any part thereof the SERVICES for any reason or for no
      ...
      <p>
        This AGREEMENT does not transfer from [YOUR_COMPANY] to you any
        [YOUR_COMPANY] or any third party intellectual property and all rights
        and such property will remain solely with [YOUR_COMPANY].
      </p>

      <h2>8. Trademarks</h2>

      <p>
        [YOUR_COMPANY] are registered trademarks of [YOUR_COMPANY]. Other
        ...
        [YOUR_COMPANY] or third-party trademarks.
      </p>

      <h2>9. Disclaimer Of Warranties</h2>

      <p>
        All SERVICES are provided 'AS IS'. [YOUR_COMPANY] hereby disclaims all
        warranties of any kind, express or implied, including, without
        limitation, the warranties of merchantability, fitness for a particular
        purpose and non-infringement. [YOUR_COMPANY] makes any warranty that the
        WEBSITE or SERVICES will be error-free or that access to the SERVICES
        will be continuous or uninterrupted. You obtain content or services
      ...
      <p>
        [YOUR_COMPANY] and it's suppliers or licensors shall not be liable with
      ...
      <p>
        You agree to defend, indemnify and hold [YOUR_COMPANY] and its
        ...
        fees arising out of your use of the WEBSTE, including but not limited to
        your violation of this AGREEMENT.
      </p>

      <p>
        [YOUR_COMPANY] reserves the right to modify these terms at any time.
