...
export const revenue = function revenue() {
...
export const users = function users() {
  return [
    {
      id: 1,
    ...
    },
    {
      id: 6,
      name: "Amanda Walsh",
      email: "amanda.walsh@example.com",
      plan: "enterprise",
      created: "07 Apr 2019",
    },
    {
...
export const usersTypes = function userTypes() {
  const labels = "User";
  const data = [
